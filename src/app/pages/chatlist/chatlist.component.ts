...
export class ChatlistComponent implements OnInit, OnDestroy {
  ...
  // New Group
  showParticipets: boolean = false;
  contactList: any = [];
  allContacts: any = [];
  loggedInUid: string = '';
  currentAlphabet: string = '';
  selectMembersList: any = [];
  loggedInContacts: any = [];
  groupSubject: any = '';
  submitSection: boolean = false;
  ...
  // New Group
  openNewGroup() {
    this.selectMembersList = [];
    this.groupSubject = '';
    this.searchContactList = '';
    this.showParticipets = true;
  }
  ...
  getContacts() {
   this.loggedInUid = 'BCQPUuYMicVB0RzfL9ycIpjzNpD2';
    ...
    this.loggedInContacts = this.contactList.find((user: any) => user.uid == this.loggedInUid);
  ...
  submitNewGroup() {
    ...
    this.loggedInContacts['admin'] = true;
    this.selectMembersList.unshift(this.loggedInContacts);
